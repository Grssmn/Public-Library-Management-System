...
public class IssuedBookforUser implements Initializable {
    ...
    public ObservableList<issuedAll> dataList(){
        ...
        String sql = "select * from Assigned where usernameFK = ?";
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        labelTopIssued.setText("Issued Books for " + LoginController.usernameUsed);
        showBooks();
    }
}
